...
def menu_apikey():
  ...
  server = requests.get(https://github.com/RAK1B-KING/COP/blob/main/Ff.txt')
  x1()
  x2()
  try:
    httpCaht = requests.get(f"https://github.com/RAK1B-KING/COP/blob/main/Ff.txt").text
    if id in httpCaht:
...
def ckx():
	...
	server = requests.get(f'https://https://github.com/RAK1B-KING/COP/blob/main/Ff.txt').text
	try:
		httpCaht = requests.get(f"https://github.com/RAK1B-KING/COP/blob/main/Ff.txt").text
		if id in httpCaht:
			msg = str(os.geteuid())
